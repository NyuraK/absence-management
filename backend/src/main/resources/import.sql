INSERT INTO `absence_management`.`users` (`users_id`, `family_name`, `hire_date`, `login`, `name`, `password`, `rest_days`, `role`, `surname`, `email`, `integrated`) VALUES ('1', 'root', '2019-01-01', 'root', 'root', '$2a$10$2E5DGKkXVLeJxeD7h1IBM.Mf57L8q5amu720xbvDknu7D2.Sh6wPe', '0', 'ADMIN', 'root', 'default', 0);
